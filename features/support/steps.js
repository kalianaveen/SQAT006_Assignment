...
When('I type Username valid signup', function(callback) {
  this.browser
    .waitForVisible('.register-page__username-input', 2000)
    .setValue('.register-page__username-input','chesleacdefghi')
    .setValue('.register-page__email-input','chesleacdefghi@gmail.com')
    .setValue('.register-page__password-input','chesleacdefghi12345')
    .setValue('.register-page__confirm-password-input','chesleacdefghi12345')
    .selectByIndex('.register-page__specialties-list', 6)
    .selectByIndex('.register-page__specialties-other-list', 12)
    .scroll('.box')
    .click('.box')
...
Then('I should see result valid signup', function(callback) {
  this.browser
    ...
    result.should.equal("Is your email address still chesleacdefghi@gmail.com?");
...
When('I type email address and password', function(callback) {
  this.browser
    ...
    .setValue('.login-page__email-input','chesleacdefghi@gmail.com')
    .setValue('.login-page__password-input','chesleacdefghi12345')
